...
const FinalStepMaintenancePartner = ({handleChange, values}) => {
  console.log(" ==== FINAL STEP MAINTENACE PARTNER ==== ")
  console.log(values)
  ...
  const onSubmitPress = () => {
    ...
    if (values.businessType == 4 ) {
      ...
      Axios.post(`${API}post/MaintenancePartner`, {
...
export default FinalStepMaintenancePartner;
